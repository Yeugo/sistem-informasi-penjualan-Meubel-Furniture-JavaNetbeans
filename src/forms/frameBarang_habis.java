 ...
 */
package forms;
import dataset.dataBarang_habis;
 ...
 * @author ACER
 */
public class frameBarang_habis extends javax.swing.JFrame {
    
    dataBarang_habis data; 
    /**
     * Creates new form frameBarang_habis
     */
    public frameBarang_habis() {
        initComponents();
        this.setLocationRelativeTo(null);
        data = new dataBarang_habis();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Data Barang Habis");
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtJumlah, txtKode_barang, txtKode_supplier, txtNama_barang});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        data.insertJumlah_stok(Integer.valueOf(txtJumlah.getText()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String isiPesan = "Kode Barang   : "+data.getRecordKode_barang().get(i)+
                          ...
                          "\nJumlah Stock  : "+data.getRecordJumlah_stok().get(i)+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameBarang_habis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameBarang_habis().setVisible(true);
            }
        });
    }
